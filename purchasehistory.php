...
<head>
    ...
    <link rel="shortcut icon" href="./resources/logo.svg">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- <div class="col-12 text-center bg-light">
                <span class="fs-1 fw-bold text-black-50 d-block" style="margin-top: 200px; margin-bottom: 200px;"> You have no item in your Transaction History yet...</span>
            </div> -->
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-1 bg-info text-center text-lg-start">
                                <label class="form-label text-white fs-6 py-5">1111111</label>
                            </div>
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="row g-2">
                                    ...
                                    <div class="card mx-0 my-3">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img src="resources/products/622fe324010cd13mini1000.jpg" class="img-fluid rounded-start">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title">Iphone 12</h5>
                                                    <p class="card-text"><b>Seller : </b>Lahiru Viraj</p>
                                                    <p class="card-text"><b>Price : </b>Rs.10000.00</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-lg-2 text-center text-lg-end bg-info">
                                <label class="form-label text-white fs-5 py-5 fw-bold">Rs. 100000.00</label>
                            </div>

                            <div class="col-12 col-lg-2 text-center text-lg-end bg-light">
                                <label class="form-label fs-5 py-5 px-3 fw-bold">2021-10-16 23:06:47</label>
                            </div>
            ...
            <div class="col-12 mb-3">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-2 d-block text-end">
